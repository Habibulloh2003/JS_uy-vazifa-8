...
function timer() {
    ...
    headerTimer.innerHTML = step
}

timer()

let img = document.querySelectorAll('.main__product-info')
let imgSrc = document.querySelectorAll('.main__product-info img')
// let imgAttr = imgSrc.getAttribute('src')
let view = document.querySelector('.view')
let viewImg = document.querySelector('.view img')
let viewImgAttr = viewImg.getAttribute('src')
img.forEach(item => {
  item.addEventListener('dblclick', e=> {
    view.style.display = 'flex'
    view.classList.add('active')
    viewImgAttr = imgSrc.getAttribute('src')
  })
})
